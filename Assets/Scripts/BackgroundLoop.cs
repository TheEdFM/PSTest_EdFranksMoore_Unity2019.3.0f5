...
public class BackgroundLoop : MonoBehaviour
{
    ...
    void loadChildObjects(GameObject obj)
    {
        ...
        int childsNeeded = (int)Mathf.Ceil(screenLimits.x * 2 / objectHeight);
    ...
    void repositionChildObjects(GameObject obj)
    {
        ...
        if (children.Length > 1)
        {
            ...
            if (transform.position.y + screenLimits.y > lastChild.transform.position.y + halfObjectHeight)
            {
            ...
            } else if (transform.position.y - screenLimits.y < firstChild.transform.position.y - halfObjectHeight)
            {
